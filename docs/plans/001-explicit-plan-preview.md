...
| `internal/plan/legacy_compatibility_test.go` | Fixed pre-migration v1 bytes/MAC, nonempty candidate fingerprint, preserved snapshot intent |
...
- The whole-slice AI review reported no P1/P2 findings and requested two non-blocking refinements: a historical nonempty v1 vector and corrected traceability wording. The vector embedded in `legacy_compatibility_test.go` was generated by the pure `CandidateFingerprint` and `encodeSignedPlan` functions at pre-migration base `1d4fca390e28db9b68a7ee7456df0892d1f7cae9`, using its synthetic `storedPlanFixture` and fixed test key `0x42` repeated 32 times. Its expected fingerprint is `sha256:b4083e834dddc15392c72110182f51a2356e135d2433a62797efb3f4b887dd80`. The temporary source export/generator is not tracked; no source-reader assessment was performed. The traceability table now distinguishes implemented schema binding from pending eligibility/apply.
